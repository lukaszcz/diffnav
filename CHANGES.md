[DiffNav Extra](https://github.com/lukaszcz/diffnav) is a fork of [DiffNav](https://github.com/dlvhdr/diffnav) with extra features and bespoke modifications.
...
- toggle directories on file tree click,
